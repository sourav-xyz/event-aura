        ...
        <div className="max-w-4xl">
          ...
          >
            <div className="flex items-center gap-1 bg-accent/20 px-4 py-2 rounded-full border border-accent/30">
              ...
              <span className="text-sm font-medium text-accent-foreground">Trusted by 500+ Happy Customers</span>
            </div>
          </motion.div>
          ...
          >
            Weddings, Birthdays, Corporate Events & More. Transform your special moments into unforgettable memories with EventAura.
          </motion.p>
          ...
          >
            <Button asChild size="lg" className="gradient-primary text-primary-foreground hover:opacity-90 shadow-xl text-lg px-8 py-6">
              <Link href="#booking">
                Book Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-2 border-primary/30 hover:bg-primary/10 text-lg px-8 py-6">
              <Link href="#gallery">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-foreground">500+ Events</p>
                <p className="text-sm text-muted-foreground">Successfully Delivered</p>
              </div>
            </div>
            <div className="h-12 w-px bg-border hidden sm:block" />
            <div>
              <p className="font-semibold text-foreground">Bhubaneswar & Berhampur</p>
              <p className="text-sm text-muted-foreground">Serving Odisha with Excellence</p>
            </div>
          </motion.div>
        </div>
      </div>
